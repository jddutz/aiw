...
CREATE TABLE `project_template_genres` (
  ...
  CONSTRAINT `project_template_genres_ibfk_1` FOREIGN KEY (`genre_id`) REFERENCES `genres` (`id`),
  CONSTRAINT `project_template_genres_ibfk_2` FOREIGN KEY (`project_template_id`) REFERENCES `project_templates` (`id`)

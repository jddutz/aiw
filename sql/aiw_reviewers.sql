...
CREATE TABLE `reviewers` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `reviewers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `reviewers_ibfk_2` FOREIGN KEY (`writing_project_id`) REFERENCES `writing_project` (`id`)
